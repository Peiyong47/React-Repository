...
export default function Header() {
  return (
    <div className='border-b bg-westly-600  py-3 shadow-lg w-full sticky top-0 left-0 right-0 z-50'>
        <Navbar className='max-w-screen-xl bg-westly-600 mx-auto text-westly-100 '>
